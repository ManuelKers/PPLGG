...
public class GameOfLifeAgent extends AbstractAgent {

	
	private int minSize = 3; 
	private int maxSize = height;
	
	// size is the area in which the agent will have influence
	private int size;
	
	boolean first = true;

	public GameOfLifeAgent(MapManager newManager, int tokens, Position spawnPos,
			int waitingPeriod) {
